...
ENV["RAILS_ENV"] = "test"
# ruby_llm resolves the provider on Chat creation; we never make real calls
...
VCR.configure do |c|
  ...
  c.filter_sensitive_data("<OPENAI_API_KEY>") { ENV.fetch("OPENAI_API_KEY", "test-key") }
